...
- [x] The form panel, color fields, fields, consent control, action, and mobile reply path remain uncropped.
- [x] Keyboard focus, target size, and mobile form visibility clear the deterministic gate.
